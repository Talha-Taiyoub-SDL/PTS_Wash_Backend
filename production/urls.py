...
router.register(
    "received-bundles", views.ReceivedBundleViewSet, basename="received-bundles"
)
router.register("batch-bundles", views.BatchBundleViewSet, basename="batch-bundle")
...
router.register(
    "batch-stage-history",
    views.BatchStageHistoryViewSet,
    basename="batch-stage-history",
)
router.register("rejections", views.RejectionViewSet, basename="rejection")
router.register(
    "qc-stage-summaries", views.BatchQcStageSummaryViewSet, basename="qc-stage-summary"
)
